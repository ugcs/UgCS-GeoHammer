...
public class DblArray {
	...
	public  static void main(String [] args){
		...
		for(int i = 1; i< 630; i++){
			da.drawCircle(rand.nextInt(da.width), rand.nextInt(da.height), 
					40+ (int)(rand.nextDouble()*rand.nextDouble()*rand.nextDouble() *120), 
						rand.nextDouble() * rand.nextDouble() * 100);
