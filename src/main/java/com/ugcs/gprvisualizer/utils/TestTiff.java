...
public class TestTiff {
	...
	private static final String[] USAGE = { "Usage ReadTagsAndImages <input file>  [output file]",
	 ...
	 * output. If an output root-name is specified, write images to specified path.
	 *
	 * @param args the command line arguments
	 * @throws org.apache.commons.imaging.ImageReadException in the event of an
	 *                                                       internal data format or
	 *                                                       version compatibility
	 *                                                       error reading the
	 *                                                       image.
	 * @throws java.io.IOException                           in the event of an I/O
	 *                                                       error.
	 */
	public static void main(String[] args) throws ImageReadException, IOException {

		//File target = new File("d:\\tmp\\tiff\\gps32.tif");
		//File target = new File("d:\\tmp\\tiff\\created1.tif");
		File target = new File("d:\\tmp\\tiff\\created2.tif");
		//File target = new File("d:\\tmp\\tiff\\ilatlon_float.tif");
		//File target = new File("d:\\tmp\\tiff\\bogota.tif");
		
		//File target = new File("d:\\tmp\\tiff\\5ed7ff02350cfa0006925539.tif");
		//File target = new File("d:\\tmp\\tiff\\sample_detail_4.tif");
		//File target = new File("d:\\tmp\\tiff\\boffa-1986_guinea.tif");
		...
		TiffContents contents = tiffReader.readDirectories(byteSource, optionalImageReadingEnabled,
		...
		for (TiffDirectory directory : contents.directories) {
			...
			if (optionalImageReadingEnabled && hasTiffImageData) {
				...
				BufferedImage bImage = directory.getTiffImage(ByteOrder.LITTLE_ENDIAN, params);
